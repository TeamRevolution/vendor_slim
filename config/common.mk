...
PRODUCT_VERSION_MAINTENANCE = 13
...
# Set all versions
SLIM_VERSION := Revolution-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(SLIM_BUILD_TYPE)$(SLIM_POSTFIX)
