...
PRODUCT_VERSION_MAINTENANCE = R13 BETA
...
# Set all versions
SLIM_VERSION := Revolution-$(PRODUCT_VERSION_MAINTENANCE).$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(SLIM_BUILD_TYPE)$(SLIM_POSTFIX)
SLIM_MOD_VERSION := Revolution-$(SLIM_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(SLIM_BUILD_TYPE)$(SLIM_POSTFIX)
